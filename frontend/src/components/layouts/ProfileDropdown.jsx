...
const ProfileDropdown = ({
  ...
  return (
    <div className='relative'>
        <button
            onClick={onToggle}
            className='flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-50 transitions-colors duration-200'
        >
            {avatar ? (
                <img 
                    src={avatar}
                ...
                <div className="h-8 w-8 bg-gradient-to-br from-blue-900 to-blue-900 rounded-xl flex items-center justify-center">
